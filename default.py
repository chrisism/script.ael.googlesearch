...
def run_plugin():
    ...
    logger.info('------------ Called Advanced Emulator Launcher Plugin: Googlesearch Scraper ------------')
    ...
    parser = argparse.ArgumentParser(prog='script.ael.googlesearch')
    ...
    logger.debug('Advanced Emulator Launcher Plugin: Googlesearch Scraper -> exit')
